...
impl SessionSummaryScreen {
    ...
    pub fn show_session_summary(
        ...
        execute!(stdout, SetForegroundColor(Colors::to_crossterm(Colors::TEXT)))?;
        execute!(stdout, Print(format!("{:.1}s", session_result.session_duration.as_secs_f64())))?;
        execute!(stdout, ResetColor)?;
        ...
        execute!(stdout, SetForegroundColor(Colors::to_crossterm(Colors::TEXT)))?;
        execute!(stdout, Print(format!("{}", session_result.valid_keystrokes + session_result.invalid_keystrokes)))?;
        execute!(stdout, Print(" | "))?;
        ...
        execute!(stdout, SetForegroundColor(Colors::to_crossterm(Colors::TEXT)))?;
        execute!(stdout, Print(format!("{}", session_result.valid_mistakes + session_result.invalid_mistakes)))?;
        execute!(stdout, Print(" | "))?;
        ...
        execute!(stdout, SetForegroundColor(Colors::to_crossterm(Colors::TEXT)))?;
        execute!(stdout, Print(format!("{:.1}%", session_result.overall_accuracy)))?;
        execute!(stdout, ResetColor)?;
