...
impl CommonExtractor {
        ...
        chunks.sort_by(|a, b| {
            ...
            if pos_cmp == std::cmp::Ordering::Equal {
                let a_priority = match a.chunk_type {
                    ...
                    crate::models::ChunkType::File => 20,
                    _ => 5,
                };
    ...
    fn build_middle_chunk_local(
        ...
        capture_name: &str,
        chunk_type: crate::models::ChunkType,
        content: &str,
        start_byte: usize,
        end_byte: usize,
    ...
    fn node_to_chunk_cached(
        ...
        let chunk_type = match capture_name {
            "function" => crate::models::ChunkType::Function,
            "class" => crate::models::ChunkType::Class,
            "method" => crate::models::ChunkType::Method,
            _ => crate::models::ChunkType::CodeBlock,
        };

        Some(crate::models::CodeChunk {
            name: capture_name.to_owned(),
            content: normalized_content,
            chunk_type,
